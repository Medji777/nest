...
import {PostsLike, PostsLikeDocument, PostsLikeModelType} from "./postsLike.schema";
...
export class PostsLikeRepository {
    ...
    create(userId: string, postId: string, login: string, likeStatus: LikeStatus): PostsLikeDocument {
    ...
    async findByUserIdAndPostId(userId: string, postId: string): Promise<PostsLikeDocument> {
