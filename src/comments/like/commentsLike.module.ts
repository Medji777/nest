...
@Module({
    imports: [
        MongooseModule.forFeature([{name: CommentsLike.name, schema: CommentsLikeSchema}])
    ],
    providers: [CommentsLikeService, CommentsLikeRepository, CommentsLikeQueryRepository],
