...
export class CheckUniqueLoginOrEmailValidate implements ValidatorConstraintInterface {
    ...
    async validate(loginOrEmail: string, validationArguments?: ValidationArguments): Promise<boolean> {
        return this.usersQueryRepository.getIsUniqueUserByLoginOrEmail(loginOrEmail);
    }
